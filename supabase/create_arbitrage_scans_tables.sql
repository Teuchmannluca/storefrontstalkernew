-- Create table for arbitrage scans
...
-- Create table for scan opportunities/results
...
CREATE INDEX idx_arbitrage_scans_user_id ON arbitrage_scans(user_id);
CREATE INDEX idx_arbitrage_scans_status ON arbitrage_scans(status);
CREATE INDEX idx_arbitrage_scans_started_at ON arbitrage_scans(started_at DESC);
CREATE INDEX idx_arbitrage_opportunities_scan_id ON arbitrage_opportunities(scan_id);
CREATE INDEX idx_arbitrage_opportunities_asin ON arbitrage_opportunities(asin);
CREATE INDEX idx_arbitrage_opportunities_roi ON arbitrage_opportunities(best_roi DESC);
...
-- Function to clean up old scans (optional, can be called periodically)
